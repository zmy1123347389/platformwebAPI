package com.behere.common.utils.pay.handler;
...
import com.behere.common.utils.pay.TenpayHttpClient;
...
public class PrepayIdRequestHandler extends RequestHandler {
    ...
    public String createMD5Sign() {
        ...
        String params=sb.append("key="+PayConstant.APP_KEY).substring(0);
